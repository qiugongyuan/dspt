...
# 安迅物流
driver.get("http://login.atguat.com.cn/login")
driver.maximize_window()


# 账号登录
driver.find_element_by_id('username').clear()
driver.find_element_by_id('username').send_keys('fengjiangwei')
...
sleep(5)
# 切换当前平台
driver.find_element_by_xpath('//*[@id="_easyui_combobox_i1_19"]').submit()
sleep(10)
