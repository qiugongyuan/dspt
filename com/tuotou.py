...
sleep(1)
# 取派分单
driver.find_element_by_xpath('//*[@id="_easyui_tree_25"]/span[4]').click()
sleep(3)
# 运单号
...
sleep(1)
# 右键
element4 = driver.find_element_by_xpath('//*[@id="takePlanAdd_sendWaybill_Page"]/div/div/div/div[1]/div[2]/div[2]')
